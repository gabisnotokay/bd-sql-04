...
update categoria set Descricao = 'Queijo' where Cod_Categoria = 4;

update categoria set Nome_Categoria = 'Confeitos' where Cod_Categoria = 3;
...
update Envio set Pais = null where Pais like 'Switzerland';

update Envio set Regiao = 'Nada' where Pais like 'NULL';

update Envio set NomeNavio = 'Canarinho' where NomeNavio like 'Hanari Carnes';

update Envio set Frete  >= 100 where Frete = 200;

update Envio set Regiao = 'Norte' where Regiao like 'Sul';
...
update Territorio set Cod_Territorio = '9' where Cod_Regiao < 3000;
